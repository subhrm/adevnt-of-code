...
def red_file(file_name: str, grid_size: int, steps: int):
...
def process_file(file_name: str, grid_size: int, steps: int):
    grid = red_file(file_name, grid_size, steps)
    return find_path(grid, grid_size)


if __name__ == "__main__":
    print(process_file("18_example_7x7.txt", 7, 12))
    print(process_file("18_input_71x71.txt", 71, 1024))
